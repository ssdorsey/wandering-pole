...
govmodel <- felm(pct.polarizing ~ govdist + Pres.Party + PVIABS + chamber.y + female + republican | congress.x, data = congresstweets)
DWmodel <- felm(pct.polarizing ~ DWdist + Pres.Party + PVIABS + chamber.y + female + republican| congress.x, data = congresstweets)
